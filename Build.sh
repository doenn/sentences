...
javac -cp junit-platform-console-standalone-1.1.0.jar:src/test/resources:src/main/java/sentences:src/test/java/sentences src/test/java/sentences/*.java src/main/java/sentences/*.java
rm -rf doc/javadoc
